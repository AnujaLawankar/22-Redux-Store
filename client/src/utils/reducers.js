...
//A reducer is a function in Redux that specifies how the application's state should change in response to dispatched actions. It takes in the current state and an action as arguments and returns the new state.
